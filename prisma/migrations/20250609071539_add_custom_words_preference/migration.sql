...
INSERT INTO "new_users" ("approvedAt", "approvedById", "createdAt", "customDomain", "email", "emailVerified", "embedAuthor", "embedColor", "embedDescription", "embedFooter", "embedTitle", "id", "image", "isAdmin", "isApproved", "maxFileSize", "maxUploads", "name", "showFileInfo", "showUploadDate", "storageUsed", "updatedAt") SELECT "approvedAt", "approvedById", "createdAt", "customDomain", "email", "emailVerified", "embedAuthor", "embedColor", "embedDescription", "embedFooter", "embedTitle", "id", "image", "isAdmin", "isApproved", "maxFileSize", "maxUploads", "name", "showFileInfo", "showUploadDate", "storageUsed", "updatedAt" FROM "users";
DROP TABLE "users";
