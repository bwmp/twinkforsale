...
INSERT INTO "new_users" ("approvedAt", "approvedById", "createdAt", "customDomain", "customUploadDomain", "email", "emailVerified", "embedAuthor", "embedColor", "embedDescription", "embedFooter", "embedTitle", "id", "image", "isAdmin", "isApproved", "maxFileSize", "maxUploads", "name", "showFileInfo", "showUploadDate", "storageUsed", "updatedAt", "useCustomWords") SELECT "approvedAt", "approvedById", "createdAt", "customDomain", "customUploadDomain", "email", "emailVerified", "embedAuthor", "embedColor", "embedDescription", "embedFooter", "embedTitle", "id", "image", "isAdmin", "isApproved", "maxFileSize", "maxUploads", "name", "showFileInfo", "showUploadDate", "storageUsed", "updatedAt", "useCustomWords" FROM "users";
DROP TABLE "users";
